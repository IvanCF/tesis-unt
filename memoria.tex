...
\thesistitle{Desarrollo de un sistema IoT de gestión y control de consumo eléctrico para viviendas y edificios usando el protocolo MQTT} % El títulos de la memoria, se usa en la carátula y se puede usar el cualquier lugar del documento con el comando \ttitle
...
\director{Mg. Ing. Edwin Mendoza Torres} % El nombre del director, se usa en la carátula y se puede usar el cualquier lugar del documento con el comando \dirname
...
A mi asesor Mg. Ing. Edwin Mendoza Torres por su buena predisposición y orientación durante la realización del presente trabajo.

A mi tía Corina Cruz Perez por todo su apoyo y a todas las personas que contribuyeron para culminar con éxito esta meta propuesta.
